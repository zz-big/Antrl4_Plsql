 ...
 * @date 2021/10/12
 */
public class ConnectionProviderHikariCP implements ConnectionProvider {
     ...
     * @return
     */
    public List<Map<String, Object>> excuteQuery(String sql, Object obj) throws SQLException {
     ...
     * @return
     */
    public List<Map<String, Object>> excuteQuery(String sql, Object[] objs) throws SQLException {
     ...
     * @return
     */
    public int excuteUpdate(String sql, Object obj) throws SQLException {
        Object[] objs = new Object[1];
        objs[0] = obj;
